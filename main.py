...
video_parser.add_argument("PATH_TO_VIDEO_FILE", type=str, help="The path to the video file that will be converted to maps or blocks")
...
audio_parser = parsers.add_parser("audio", help="splits audio into chunks")
