def main():
    ...
    video_parser.add_argument("-p", "--name-prefix", default="video_", type=str, dest="name_prefix", help="Specifies the name that will be prefixed to every generated frame")
    ...
    audio_functions_parser.add_argument("-d","--datapack-name", type=str, default="player", dest="datapack_name", help="The name you wish to give to your datapack, should remain consistent across all functions and be less than 13 alphabetic lowercase characters")
    ...
    playback_control_functions_parser.add_argument("-a","--control-audio", action="store_true", default=False, type=bool, dest="control_audio", help="If present, the functions will be able to control the audio playback aswell, if the datapack uses no audio, enabling this option will break the playback control")
